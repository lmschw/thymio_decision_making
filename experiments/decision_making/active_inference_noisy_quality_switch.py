...
class ActiveInferenceNoisyQualitySwitchExperiment(ActiveInferenceBaselineExperiment):
    """
    Combines ActiveInferenceNoisyExperiment and
    ActiveInferenceQualitySwitchExperiment: defaults to both the elevated
